    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <Button
            onClick={onBack}
            className="bg-gray-800/80 hover:bg-gray-700/80 text-gray-300 border-2 border-gray-700"
          >
        ...
        {/* Content */}
        <div className="bg-gray-900/80 backdrop-blur-md rounded-2xl p-8 border-2 border-gray-700">
          {phase === 'lesson' && (
            <div>
          ...
          {phase === 'result' && (
            <div className="text-center">
              <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-amber-400 text-4xl mb-6">🎉 Level Complete!</h2>
              ...
              {getStars() >= 3 && (
                <div className="bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 rounded-xl p-6 mb-6 shadow-lg shadow-yellow-500/30">
                  <p className="text-xl text-black">🏅 New Badge Unlocked!</p>
